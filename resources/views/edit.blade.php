            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="form-group has-validation">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{$employee->name1}}" required> 
                        @if($errors->has('name1'))
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="salary" name="salary" id="salary" class="form-control" value="{{$employee->salary}}" required>
