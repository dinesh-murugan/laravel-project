    ...
    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    @if($errors->has('name')) {{'is-invalid'}} @endif " placeholder="Enter your product" value="{{old('name',$product->name)}}"/>
                    @if($errors->has('name'))
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    @if($errors->has('mrp')) {{'is-invalid'}} @endif" placeholder="Enter M.R.P" value="{{old('mrp',$product->mrp)}}"/>
                    @if($errors->has('mrp'))
                ...
                <div class="col-md-6">
                    ...
                    @if($errors->has('price')) {{'is-invalid'}} @endif" placeholder="Enter selling Price" value="{{old('price',$product->price)}}"/>
                    @if($errors->has('price'))
